          ...
          <div className="p-6 md:p-8 rounded-2xl bg-zinc-950/95 backdrop-blur-xl border border-zinc-800 shadow-xl shadow-black/5 relative overflow-hidden group">
            ...
            <div className="flex items-center justify-between border-b border-zinc-100 dark:border-zinc-800 pb-5 mb-5 relative z-10">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-xl font-bold tracking-wider font-serif bg-clip-text text-transparent bg-gradient-to-r from-zinc-900 to-zinc-600 dark:from-zinc-100 dark:to-zinc-500">
                    天纪·紫微起盘
                  </h1>
            ...
            <div className="space-y-5 relative z-10">
              ...
              <div className="pt-2">
                  ...
                  <div className="flex items-center justify-between mb-3 relative z-10">
                    <h4 className="text-[12px] font-bold text-zinc-800 dark:text-zinc-200 flex items-center gap-1.5 font-serif tracking-widest pl-1">
